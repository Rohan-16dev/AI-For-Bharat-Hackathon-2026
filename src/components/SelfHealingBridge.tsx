                      ...
                      <ReactMarkdown
                         components={{
                          ...
                          code: ({node, inline, ...props}: any) => 
                            inline ? <code className="bg-white/50 px-1 py-0.5 rounded text-blue-800 font-mono text-[10px]" {...props} /> 
                                  : <pre className="bg-white/50 p-2 rounded text-[10px] font-mono overflow-x-auto mb-2"><code {...props} /></pre>
                        }}
                      >
                        {this.state.healerResponse.replace(/^\* /gm, '- ')}
                      </ReactMarkdown>
                    </div>
